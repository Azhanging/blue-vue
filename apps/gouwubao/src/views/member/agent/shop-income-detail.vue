...
<template>
	<bv-home-view :router-level="3" style="background-color: rgb(244,244,244);">
		...
		<div class="bc-row bc-pd-tb-10rp bc-bg-white bc-t-666 bc-flex bc-flex-ai-c bc-flex-jc-c bc-t-c">
			...
			<button class="bc-btn bc-btn-base bc-mg-l-2" style="padding:0.3333333333rem;" @click="search">
				搜索
			</button>
		</div>
		...
		<bv-scroll :api="api" :disabled="load.state.disabled">
			<div class="bc-row bc-bg-white bc-mg-t-15rp">
				<order-item :item="item" type="order" :key="index" v-for="(item,index) in load.data.lists" class="bc-bd-b-e5e"/>
			</div>
